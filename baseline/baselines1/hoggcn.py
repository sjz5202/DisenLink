...
class GCN_homo(nn.Module):
    def __init__(self, nfeat, adj, nhid, out):
        ...
        self.gc4 = GraphConvolution_homo(nhid, adj, out)
    ...
    def forward(self, x, adj, bi_adj, output, labels_for_lp):
        ...
        x_3, _,_= self.gc3(x, adj, bi_adj, output, labels_for_lp)
        x_4,_,_ = self.gc3(x, adj, bi_adj, output, labels_for_lp)
